...
<head>
    <meta charset="UTF-8">
    <title>Search For Labour Hrs  & Material Costs</title>
...
<body class="bg-gray-500 p-6">
    <div class="container mx-auto bg-white shadow-md rounded-lg p-6">
        ...
        <h1 class="text-2xl font-bold text-center mb-4">Search For Labour Hrs  & Material Costs</h1>
        <p class="text-xs text-red-700 text-center mb-4">Mandatory: Please select both "Mat Cost" and "Man-Hours" before searching. Otherwise, an error will occur.</p>
