...
<nav class="bg-green-800 p-2">
    <div class="flex items-center justify-between">
        ...
        <div class="space-x-4">
            <a href="index.php" class="text-white hover:bg-blue-700 px-4 py-2 rounded">Admin Login</a>
        </div>
    </div>
</nav>
...
<div class="container mx-auto bg-white shadow-md rounded-lg p-6">
    ...
    <p class="text-xs text-green-700 text-center mb-4">Press search. Ticking the box in the respective area will bring the information to selection. Note that default selection is active</p>
